...
<div class="wrap" id="aletheme-edit-slider-page" data-id="<?php echo (int)$aletheme_sliders->id ?>">
    ...
    <form action="" method="post">
        ...
        <div id="aletheme-edit-slider-wrapper" class="metabox-holder aletheme-slider-edit">
            <p class="alignleft"><a href="<?php echo Aletheme_Sliders::slidersUrl() ?>">Return to Sliders Listing</a>
            </p>
            <?php if ($aletheme_sliders->slider && $aletheme_sliders->slider->post_status == 'publish') : ?>
                <p class="alignright submitbox"><a
                            href="<?php echo Aletheme_Sliders::slidersUrl(array('action' => 'delete', 'id' => $aletheme_sliders->slider->ID, '_wpnonce' => wp_create_nonce('aletheme_slider_delete_nonce'))) ?>"
                            id="aletheme-slider-delete" class="submitdelete">Delete Slider</a></p>
            <?php endif; ?>
            ...
            <div id="titlediv">
                <div id="titlewrap">
                    <input type="text" name="title" size="40" maxlength="255" placeholder="Type slider name here"
            ...
            <?php if ($aletheme_sliders->slider) : ?>
                    ...
                    <?php foreach ($aletheme_sliders->getSlides($slider->ID) as $k => $slide) : ?>
                        <div class="slide" id="aletheme-slide-<?php echo $k ?>" data-id="<?php echo $slide->ID ?>">
                            ...
                            <div class="box-image">
                                ...
                                <span><input type="text" name="image" placeholder="Or enter an image URL"
                                             value="<?php echo $slide->post_content_filtered ?>"/></span>
                            </div>
                            <div class="box-content">
                                <div class="box-title"><span>Title</span><input type="text"
                                                                                value="<?php echo $slide->post_title ?>"
                                                                                name="title"/></div>
                                <div class="box-url"><span>URL</span><input type="text"
                                                                            value="<?php echo $slide->pinged ?>"
                                                                            name="url"/></div>
                                <div class="box-description"><span>Description</span><textarea cols="30" rows="4"
                                                                                               name="description"
                                                                                               class="description"><?php echo $slide->post_content ?></textarea>
                                </div>
                                <div class="box-html"><span>HTML</span><textarea cols="30" rows="4" name="html"
                                                                                 class="html"><?php echo $slide->post_excerpt ?></textarea>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                <p class="alignleft"><a id="aletheme-add-new-slide-button" class="button-secondary button80" href="#">Add
                        a New Slide</a></p>
                <p class="alignright" id="aletheme-save-slider-container">
                    <img src="<?php echo esc_url(admin_url('images/wpspin_light.gif')); ?>" class="ajax-loading"
                         id="aletheme-sliders-loading" alt="">
