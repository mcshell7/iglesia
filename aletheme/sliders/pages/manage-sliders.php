...
<div class="wrap" id="aletheme-sliders-page">
    ...
    <div id="aletheme-manage-sliders-wrapper">
        <div id="aletheme-create-slider-container">
            ...
            <a class="button-primary button80 alignright" id="aletheme-add-slider-button"
               href="<?php echo Aletheme_Sliders::slidersUrl(array('action' => 'create')) ?>">Create New Slider</a>
            <div class="clear"></div>
        </div>
                ...
                <?php foreach ($aletheme_sliders->getList() as $slider) : ?>
                    ...
                    <li>
                        <a href="<?php echo $aletheme_sliders->slidersUrl(array('action' => 'edit', 'id' => $slider->ID)) ?>">
							<span class="image">
								<?php if ($slide) : ?>
                                    <img src="<?php echo $slide->post_content_filtered ?>"
