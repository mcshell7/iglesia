    ...
    class TGM_Plugin_Activation
    {
        ...
        public function notices()
        {
            ...
            if (($pagenow == 'themes.php') && ($themeoptions_page == 'aletheme')) {
                ...
                //Don't show errors
            } else if ($pagenow == 'options-general.php' || $pagenow == 'options-writing.php' || $pagenow == 'options-reading.php' || $pagenow == 'options-discussion.php' || $pagenow == 'options-media.php' || $pagenow == 'options-permalink.php') {
                //Don't show errors
            } else {
