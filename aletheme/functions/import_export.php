            ...
            <div class="wrap">
                ...
                <div class="cf">
                    <div class="item-importer">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div id="backup-options">
                                ...
                                <p>
                                    <a href="?page=backup-options&action=download"
                                       class="button button-primary"><?php _e('Export Theme Options', 'aletheme'); ?></a>
                                </p>
                                ...
                                <p>
                                    ...
                                    <input type="submit" name="upload" id="upload" class="button-primary"
                    ...
                    <div class="item-importer">
                        ...
                        <p>
                            <a href="?page=backup-options&export=1" id="wie-export-button"
                               class="button button-primary"><?php _e('Export Widgets', 'aletheme'); ?></a>
                        </p>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <p>
                                ...
                                <input type="submit" name="upload_widget" id="upload_widget" class="button-primary"
                    ...
                    <div class="item-importer">
                        ...
                        <p><a href="https://wordpress.org/plugins/wordpress-importer/" target="_blank"
                              class="button-primary"><?php _e('Download WordPress Importer', 'aletheme'); ?></a></p>
                    </div>
                </div>
