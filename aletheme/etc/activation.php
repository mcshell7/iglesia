        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <?php if (!$config_writable) : ?>
                    <div class="error">
                        <p>If your <code>.htaccess</code> file were <a
                                    href="http://codex.wordpress.org/Changing_File_Permissions"
                                    target="_blank">writable</a>, we could do this automatically, but it isn&#8217;t so
                            these are the mod_rewrite rules you should have in your <code>.htaccess</code> file. Please
                            go to <a href="<?php echo admin_url('options-permalink.php') ?>">Permalinks</a> page in your
                            <strong>Settings</strong> tab and adjust your links manually.</p>
                    </div>
                <?php endif; ?>
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        <th scope="row"><?php _e('Create static front page?', 'aletheme'); ?></th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Create static front page?', 'aletheme'); ?></span></legend>
                                <select name="aletheme_theme_activation[create_front_page]" id="create_front_page">
                                    <option selected="selected"
                                            value="yes"><?php echo _e('Yes', 'aletheme'); ?></option>
                    ...
                    <tr valign="top">
                        <th scope="row"><?php _e('Create a blog page?', 'aletheme'); ?></th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Create a blog page?', 'aletheme'); ?></span></legend>
                    ...
                    <tr valign="top">
                        <th scope="row"><?php _e('Change permalink structure?', 'aletheme'); ?></th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Update permalink structure?', 'aletheme'); ?></span></legend>
                                <?php if ($config_writable) : ?>
                                    <select name="aletheme_theme_activation[change_permalink_structure]"
                                ...
                                <?php else: ?>
                                    <input type="hidden" name="aletheme_theme_activation[change_permalink_structure]"
                                           value="no"/>
